...
public sealed class PsychometryRegisteredCounsellorsFileProcessor(
    ...
    public async Task ProcessAsync(ProcessFileParameters parameters)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            if (category is null)
            {
                ...
                await categoryRepository.InsertAsync(category, shouldSaveNow: false).ConfigureAwait(false);
            }
