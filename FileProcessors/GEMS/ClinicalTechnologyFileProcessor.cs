...
public sealed class ClinicalTechnologyFileProcessor(
...
{
    private const string SurgicalSupport = "Surgical Support";
    private const string Pulmonology = "Pulmonology";
    private const string Cardiology = nameof(Cardiology);
    private const string DisciplineCode = "75";
    private int PulmonologyRowNumber = 32;
    ...
    public async Task ProcessAsync(ProcessFileParameters parameters)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            var discipline = await disciplineRepository.FetchByCodeAndSubCode(DisciplineCode, "0").ConfigureAwait(false);
