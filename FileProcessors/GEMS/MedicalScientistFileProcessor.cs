...
public sealed class MedicalScientistFileProcessor(
...
{
    private const string DisciplineCode = "69";
    ...
    public async Task ProcessAsync(ProcessFileParameters parameters)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            foreach (var row in sheet.Rows())
            {
                ...
                {
                    Console.WriteLine($"Row {row.RowNumber()} skipped owing to specification");
                    continue;
                }
