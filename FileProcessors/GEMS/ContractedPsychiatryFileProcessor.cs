...
public class ContractedPsychiatryFileProcessor(
...
{
    private const string DisciplineCode = "22";
    ...
    public async Task ProcessAsync(ProcessFileParameters parameters)
    {
        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            foreach (var row in sheet.Rows())
            {
                ...
                if (!int.TryParse(tariffCodeText, out tariffCode))
                {
                ...
                var providerProcedure = new ProviderProcedure
                {
                    ...
                    IsOldCodingStructure = row.RowNumber() >= 7 && row.RowNumber() <= 14 ? true : null,
                };
